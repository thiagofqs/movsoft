...
namespace MovSoft
{
    public partial class CadFornecedor : Form
    {
        ...
        {
            fornecedoresDTO.RazaoSocial = inputNome.Text;
            fornecedoresDTO.Cnpj = inputCpf.Text;
        ...
        {
            Parametros.razaoSocial = inputNome.Text;
            Parametros.Cnpj = inputCpf.Text;
