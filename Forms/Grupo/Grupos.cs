    ...
    public partial class Grupos : Form
    {
        ...
        private void dataGridViewGrupos_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridViewGrupos.Columns[e.ColumnIndex].Name == "AtivoCheckBox")
            {
                ...
                if (valor == "S")
                {
                    bllGeral.AtivarDesativar("grupos", "id_grupo", int.Parse(rowData.Cells[0].Value.ToString()), "N");
                }
                else
                {
                    bllGeral.AtivarDesativar("grupos", "id_grupo", int.Parse(rowData.Cells[0].Value.ToString()), "S");
                }
                CarregarGrupos();
            }
        }
